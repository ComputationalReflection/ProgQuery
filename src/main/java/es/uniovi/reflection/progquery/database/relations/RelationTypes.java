...
public enum RelationTypes implements RelationTypesInterface {
	...
	LABELED_STMT_ENCLOSES, LAMBDA_EXPRESSION_BODY, LAMBDA_EXPRESSION_PARAMETERS, MEMBER_REFERENCE_EXPRESSION, MEMBER_REFERENCE_TYPE_ARGUMENTS,
	IDENT_SELECTION_EXPR,
	...
	UNDERLYING_TYPE, AST_UNION_ALTERNATIVE, WHILE_CONDITION, WILDCARD_BOUND,    LOWER_BOUND_TYPE, UPPER_BOUND_TYPE,
    INITIALIZATION_EXPR;
}
